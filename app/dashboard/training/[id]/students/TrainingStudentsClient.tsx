...
interface TrainingStudentsClientProps {
  trainingSession: {
    id: string;
    title: string;
  };
...
export default function TrainingStudentsClient({ 
  trainingSession, 
  students, 
  stats 
}: TrainingStudentsClientProps) {
  return (
    <div>
      {/* Header */}
      <div className="mb-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        ...
        <div className="glass rounded-xl p-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-slate-400 text-sm">Revenus collectés</span>
          </div>
        ...
        <div className="glass rounded-xl p-4">
          ...
          <p className="text-3xl font-bold text-blue-400">
            {stats.totalExpected > 0 ? Math.round((stats.totalRevenue / stats.totalExpected) * 100) : 0}%
          </p>
        </div>
      </div>
                      ...
                      <td className="px-6 py-4">
                        <div className="space-y-1">
                          ...
                          <div className="text-xs text-slate-500">
                            {student.tranches.filter((t: any) => t.paidAt).length} / {student.tranches.length} tranches payées
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
